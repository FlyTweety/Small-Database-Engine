...
public:
  ...
  int KeyIndex(const KeyType &key, const KeyComparator &comparator) const; //自己加的

  int ValueIndex(const ValueType &value) const;

  ValueType ValueAt(int index) const;

  void SetValueAt(int index, const ValueType &value); //自己加的
  ...
  MappingType array_[0];//被我从private里挪出来�?
